...
const CreateGroupForm = ({ onSubmit, onCancel }: { onSubmit: (group: Omit<Group, 'id' | 'participants'>) => void; onCancel: () => void }) => {
    ...
    const [transportationType, setTransportationType] = useState<Group['transportationType']>("bus");
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        onSubmit({
            destination,
            transportationType,
            maxParticipants: parseInt(totalSlots)
        });
    };
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                <Select value={transportationType} onValueChange={(value: Group['transportationType']) => setTransportationType(value)}>
